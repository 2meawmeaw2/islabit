          ...
          >
            <Text
              className={`font-ibm-plex-arabic text-md ${
                committedToday ? "text-text-brand" : "text-text-primary"
              }`}
            >
    ...
    <SafeAreaView className="bg-bg flex-1">
      ...
      <View className="px-4 pb-2 ">
        <View className=" flex-row-reverse justify-between  items-center ">
          ...
          <Pressable
            android_ripple={{ color: "#00AEEF40", borderless: true }}
            onPress={() => router.back()}
            accessibilityRole="button"
            hitSlop={10}
            className="text-white flex-row items-center gap-2 mt-4 border-[1px]  border-border-primary rounded-full p-2"
          >
